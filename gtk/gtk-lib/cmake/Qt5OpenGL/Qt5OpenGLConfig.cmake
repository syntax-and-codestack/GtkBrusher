...
if (NOT TARGET Qt5::OpenGL)
    ...
    _populate_OpenGL_target_properties(RELEASE "Qt5OpenGL.dll" "libQt5OpenGL.dll.a" FALSE)

    if (EXISTS
        "${_qt5OpenGL_install_prefix}/bin/Qt5OpenGL.dll"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/lib/libQt5OpenGL.dll.a" )
        _populate_OpenGL_target_properties(DEBUG "Qt5OpenGL.dll" "libQt5OpenGL.dll.a" FALSE)
    endif()
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})
