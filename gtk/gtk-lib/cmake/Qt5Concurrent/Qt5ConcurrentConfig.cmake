...
if (NOT TARGET Qt5::Concurrent)
    ...
    _populate_Concurrent_target_properties(RELEASE "Qt5Concurrent.dll" "libQt5Concurrent.dll.a" FALSE)

    if (EXISTS
        "${_qt5Concurrent_install_prefix}/bin/Qt5Concurrent.dll"
      AND EXISTS
        "${_qt5Concurrent_install_prefix}/lib/libQt5Concurrent.dll.a" )
        _populate_Concurrent_target_properties(DEBUG "Qt5Concurrent.dll" "libQt5Concurrent.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Concurrent_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Concurrent_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Concurrent_check_file_exists(${imported_location})
