...
if (NOT TARGET Qt5::Sql)
    ...
    _populate_Sql_target_properties(RELEASE "Qt5Sql.dll" "libQt5Sql.dll.a" FALSE)

    if (EXISTS
        "${_qt5Sql_install_prefix}/bin/Qt5Sql.dll"
      AND EXISTS
        "${_qt5Sql_install_prefix}/lib/libQt5Sql.dll.a" )
        _populate_Sql_target_properties(DEBUG "Qt5Sql.dll" "libQt5Sql.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Sql_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Sql_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sql_check_file_exists(${imported_location})
