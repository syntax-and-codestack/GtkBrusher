...
if (NOT TARGET Qt5::Test)
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test.dll" "libQt5Test.dll.a" FALSE)

    if (EXISTS
        "${_qt5Test_install_prefix}/bin/Qt5Test.dll"
      AND EXISTS
        "${_qt5Test_install_prefix}/lib/libQt5Test.dll.a" )
        _populate_Test_target_properties(DEBUG "Qt5Test.dll" "libQt5Test.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Test_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})
