...
if (NOT TARGET Qt5::PrintSupport)
    ...
    _populate_PrintSupport_target_properties(RELEASE "Qt5PrintSupport.dll" "libQt5PrintSupport.dll.a" FALSE)

    if (EXISTS
        "${_qt5PrintSupport_install_prefix}/bin/Qt5PrintSupport.dll"
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/lib/libQt5PrintSupport.dll.a" )
        _populate_PrintSupport_target_properties(DEBUG "Qt5PrintSupport.dll" "libQt5PrintSupport.dll.a" FALSE)
    endif()
    ...
    macro(_populate_PrintSupport_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5PrintSupport_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_PrintSupport_check_file_exists(${imported_location})
