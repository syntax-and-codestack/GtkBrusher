...
if (NOT TARGET Qt5::Widgets)
    ...
    _populate_Widgets_target_properties(RELEASE "Qt5Widgets.dll" "libQt5Widgets.dll.a" FALSE)

    if (EXISTS
        "${_qt5Widgets_install_prefix}/bin/Qt5Widgets.dll"
      AND EXISTS
        "${_qt5Widgets_install_prefix}/lib/libQt5Widgets.dll.a" )
        _populate_Widgets_target_properties(DEBUG "Qt5Widgets.dll" "libQt5Widgets.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
