...
set(Qt5VulkanSupport_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.16"
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.15.16/QtVulkanSupport"
    )
    ...
    foreach(_module_dep ${_Qt5VulkanSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5VulkanSupport_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5VulkanSupport_install_prefix}/lib/libQt5VulkanSupport.a" )
        _populate_VulkanSupport_target_properties(DEBUG "libQt5VulkanSupport.a" "" FALSE)
    endif()
