...
if (NOT TARGET Qt5::Xml)
    ...
    _populate_Xml_target_properties(RELEASE "Qt5Xml.dll" "libQt5Xml.dll.a" FALSE)

    if (EXISTS
        "${_qt5Xml_install_prefix}/bin/Qt5Xml.dll"
      AND EXISTS
        "${_qt5Xml_install_prefix}/lib/libQt5Xml.dll.a" )
        _populate_Xml_target_properties(DEBUG "Qt5Xml.dll" "libQt5Xml.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Xml_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Xml_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Xml_check_file_exists(${imported_location})
