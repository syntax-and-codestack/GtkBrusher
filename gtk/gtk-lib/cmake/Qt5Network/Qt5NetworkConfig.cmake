...
if (NOT TARGET Qt5::Network)
    ...
    _populate_Network_target_properties(RELEASE "Qt5Network.dll" "libQt5Network.dll.a" FALSE)

    if (EXISTS
        "${_qt5Network_install_prefix}/bin/Qt5Network.dll"
      AND EXISTS
        "${_qt5Network_install_prefix}/lib/libQt5Network.dll.a" )
        _populate_Network_target_properties(DEBUG "Qt5Network.dll" "libQt5Network.dll.a" FALSE)
    endif()
