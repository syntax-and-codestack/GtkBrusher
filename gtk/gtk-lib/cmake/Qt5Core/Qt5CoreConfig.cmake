...
if (NOT TARGET Qt5::Core)
    ...
    set_property(TARGET Qt5::Core
                 ...
                 datetimeparser;doubleconversion;hijricalendar;icu;mimetype-database;system-pcre2;sha3-fast;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 clock-gettime;etw;futimens;futimes;getauxval;getentropy;glib;glibc;gnu-libiconv;iconv;inotify;journald;linkat;lttng;posix-libiconv;renameat2;slog2;statx;syslog)
    ...
    _populate_Core_target_properties(RELEASE "Qt5Core.dll" "libQt5Core.dll.a" FALSE)

    if (EXISTS
        "${_qt5Core_install_prefix}/bin/Qt5Core.dll"
      AND EXISTS
        "${_qt5Core_install_prefix}/lib/libQt5Core.dll.a" )
        _populate_Core_target_properties(DEBUG "Qt5Core.dll" "libQt5Core.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Core_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
