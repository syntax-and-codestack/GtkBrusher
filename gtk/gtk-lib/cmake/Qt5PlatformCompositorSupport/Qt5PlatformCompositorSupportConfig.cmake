...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.15.16)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.16"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.16/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.16 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/lib/libQt5PlatformCompositorSupport.a" )
        _populate_PlatformCompositorSupport_target_properties(DEBUG "libQt5PlatformCompositorSupport.a" "" FALSE)
    endif()
